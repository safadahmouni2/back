...
public class DailyScrum extends AbstractBaseMainTraceableEntity implements Serializable {
	...
	@Column(name = "TOTAL_IDEAL_LINE_POINTS")
	private Integer totalIdealLinePoints;
	...
	@Column(name = "TOTAL_POINTS_IN_SPRINT")
	private BigDecimal totalPointsInSprint;

	@Column(name = "NUMBER_DAYS_BY_SPRINT")
	private Integer numberDaysBySprint;
