...
public class UserStoryInputMapper extends AbstractBaseGraphQlInputMapper<UserStoryInput, UserStory> {
	...
	public UserStory create(UserStoryInput input) {
		...
		if (input != null) {
			...
			result.setParentUsTicketId(input.getParentUsTicketId());
	...
	private void patchParentTicketId(UserStoryInput input, UserStory entity) {
		if (input.canPatch(UserStoryInput.Fields.parentTicketId)) {
