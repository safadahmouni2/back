...
import com.thinktank.pts.agileservice.api.graphql.input.SearchUserStoryInput;
...
public class QueryResolver implements GraphQLQueryResolver {
	...
	/**
	 * Method used to retrieve the list of userStories by sprintId or sprintTicketId
	 * 
	 * @param sprintId,
	 *            sprintTicketId
	 * @return CollectionResult<UserStory> created {@link com.thinktank.pts.agileservice.model.UserStory}
	 */
	public CollectionResult<UserStory> searchUserStories(SearchUserStoryInput input) {

		CollectionResult<UserStory> result = new CollectionResult<>();
		result.setItems(this.userStoryService.searchUserStories(input.getSprintId(), input.getSprintTicketId()));
	 ...
	 * 
	 * @return CollectionResult<MeetingConfig> created {@link com.thinktank.pts.agileservice.model.MeetingConfig}
	 */
	public CollectionResult<MeetingConfig> searchMeetingConfigs(SearchMeetingConfigInput input) {

		CollectionResult<MeetingConfig> result = new CollectionResult<>();
		result.setItems(this.meetingConfigService.searchMeetingConfigs(input));

		return result;
	}

	/**
	 * Method used to retrieve user details by us ticketId
	 * 
	 * @param ticketId
	 * @return
	 */
	public UserStory getUserStoryByTicketId(Long ticketId) {
		return userStoryService.getUserStoryByTicketId(ticketId);
	}
