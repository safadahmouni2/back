...
import com.thinktank.pts.agileservice.api.graphql.input.mapper.MeetingConfigInputMapper;
...
public class Mutation implements GraphQLMutationResolver {
	...
	private MeetingConfigInputMapper meetingConfigInputMapper = new MeetingConfigInputMapper();
	...
	/**
	 * api to create new MeetingConfig
	 * 
	 * @param input
	 * @return meetingConfig created
	 */
	public MeetingConfig createMeetingConfig(MeetingConfigInput input) {
		MeetingConfig meetingConfig = meetingConfigInputMapper.create(input);
		return meetingConfigService.create(meetingConfig);
	}

	/**
	 * api to create new MeetingAttendee
	 * 
	 * @param input
	 * @return meetingAttendee created
	 */
	public MeetingAttendee createMeetingAttendee(MeetingAttendeeInput input) {
		return meetingAttendeeService.create(input);
	}
	...
	/**
	 * api to create new MeetingParticipant
	 * 
	 * @param input
	 * @return meetingParticipant created
	 */
	public MeetingParticipant createMeetingParticipant(MeetingParticipantInput input) {
		return meetingParticipantService.create(input);
	}
}
