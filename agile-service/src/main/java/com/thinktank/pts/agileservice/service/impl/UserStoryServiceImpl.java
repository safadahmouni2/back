...
import static com.thinktank.pts.agileservice.repository.specs.UserStorySpecs.specification;
...
public class UserStoryServiceImpl implements UserStoryService {
	 ...
	 */
	@Override
	public List<UserStory> searchUserStories(Long sprintId, Long sprintTicketId) {
		return userStoryRepository.findAll(specification(sprintId, sprintTicketId));
	...
	public UserStory getUserStoryByTicketId(Long ticketId) {
		return userStoryRepository.findByTicketId(ticketId);
	}
