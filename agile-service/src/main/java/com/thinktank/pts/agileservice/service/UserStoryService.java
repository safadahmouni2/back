...
public interface UserStoryService {
	...
	/**
	 * Method used to retrieve the list of user Story by sprintId or sprintTicketId or stateId
	 * 
	 * @param sprintId,
	 *            sprintTicketId
	 * @return List UserStory {@link com.thinktank.pts.agileservice.model.UserStory}
	 */
	List<UserStory> searchUserStories(Long sprintId, Long sprintTicketId);
	 ...
	 * @return userStory details {@link com.thinktank.pts.agileservice.model.UserStory}
	 */
	UserStory getUserStoryByTicketId(Long ticketId);
