...
DECLARE t_creator, t_user_code VARCHAR(250) CHARACTER SET UTF8;
...
INSERT INTO ds_participant (ticket_id, daily_scrum_id, user_id, user_code, state_id , creator, created, modifier, modified,exported_at, client_ref)
VALUES(
	   t_ticket_id,
	   t_daily_scrum_id,
	   t_user_id,
