...
DECLARE t_name,
        t_description VARCHAR(250) CHARACTER SET UTF8;
...
INSERT INTO topic (ticket_id, state_id, product_id, project, name, description, display_order, creator, created, modifier, modified,exported_at, client_ref)
VALUES( t_ticket_id,
       t_state_id,
       t_product_id,
       t_project_id,
