...
DECLARE t_role VARCHAR(100) CHARACTER SET UTF8;
...
INSERT INTO sprint_member (ticket_id, sprint_id, state_id,  role , creator, created, modifier, modified, user_code, client_ref)
VALUES(
	   t_ticket_id,
	   t_sprint_id,
	   t_state_id,
