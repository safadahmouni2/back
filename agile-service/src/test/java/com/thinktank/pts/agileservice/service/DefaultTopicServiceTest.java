...
class DefaultTopicServiceTest extends AbstractPersistenceTestBase {
	...
	void saveDefaultTopic_Success() {
		...
		parameters.excludeField(
				FieldPredicates.named(FIELD_NAME_TICKET_ID).and(FieldPredicates.inClass(DefaultTopic.class)));
	...
	private EasyRandomParameters buildEasyRandomParameters() {
		...
		result.excludeField(FieldPredicates.named(FIELD_NAME_TICKET_ID).and(FieldPredicates.inClass(Topic.class)));
		result.excludeField(
				FieldPredicates.named(FIELD_NAME_TICKET_ID).and(FieldPredicates.inClass(DefaultTopic.class)));
		return result;
	}
