...
class SprintRepositoryTest extends AbstractPersistenceTestBase {
	...
	private static final String FIELD_NAME_SPRINT = "sprint";
	...
	void getSprintByProductId_Success() {
		...
		parameters
				.excludeField(FieldPredicates.named(FIELD_NAME_SPRINT).and(FieldPredicates.inClass(DailyScrum.class)));
	...
	@Ignore("Test getSprintProgress_Success Ignored (problem caused by IF ) ")
	void getSprintProgress_Success() {
		...
		parameters.excludeField(FieldPredicates.named(FIELD_NAME_SPRINT).and(FieldPredicates.inClass(UserStory.class)));
